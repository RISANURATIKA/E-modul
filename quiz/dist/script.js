...
{
  id: 3,
  text: "4.	Apa saja jenis IP Address  ?",
  answers: [
    "A. IP privat dan IP public", 
  "B. IP local dan IP public", 
  "C. IP public dan IP privat", 
...
{
  id: 4,
  text: "5. Sebuah alamat pada komputer agar komputer bisa saling terhubung dengan komputer lain disebut dengan ?",
  answers: [
    "A.IP address ", 
    "B.Broadcast address", 
...
{
  id: 5,
  text: "6.	Ip privat terdiri dari ?",
  answers: [
    "A.Net ID dan Host ID", 
    "B.Kode vendor dan kode hardware", 
    "C.Broadcats dan Netmask", 
    "D.Fisrt host dan Lost host"],
  correct: 0,
  selection: null },

{
  id: 6,
  text:
  "7.	Pengertian routing dinamis adalah ?",
  answers: [
    "A.Salah satu jaringan yang swring digunakan", 
    "B.Routing yang dilakukan oleh router dengan cara membuat jalur komunikasi data secara otomatis sesuai dengan pengaturan yang dibuat", 
    "C.Jenis routing yang dilakukan admin/pengelola jaringan untuk mengkonfigurasikan informasi tentang jaringan yang dituju secara manual", 
    "D.Sebuah meknanisme yang harus dijalankan pada jaringan komputer"],
  correct: 1,
  selection: null },

{
  id: 7,
  text: "8.IPv4 terdiri dari berapa Byte dan Bit ?",
  answers: [
    "A.40 Bit dan 32 Byte", 
    "B.48 Byte dan 32 Bit", 
    "C.4 Byte dan 32 Bit", 
    "D.32 Byte dan 4 Bit"],
  correct: 2,
  selection: null },

{
  id: 8,
  text:
  "9.Suatu cara/metode yang digunakan membagi sebuah network menjadi beberapa subnetwork disebut dengan ?",
  answers: [
    "A.Subneting ", 
    "B.Suubnet mask", 
    "C.Broadcast", 
...
{
  id: 9,
  text: "10.Macam-macam routing dinamis, kecuali ?",
  answers: [
  "A.	RIP",
  "B.	IGRP",
  "C.	OSPF",
  ...
  {
    id: 10,
    text: "11.Urutan lapisan OSI mulai dari layer satu adalah ?",
    answers: [
  ...
  {
    id: 11,
    text: "12.Router dapat menghubungkan berapa buah jaringan ?",
    answers: [
    "A.	1 buah jaringan ",
    "B.	2 buah jaringan ",
    "C.	8 buah jaringan ",
    ...
    {
      id: 12,
      text: "13.Jenis routing yang dapat berubah sesuai dengan kondisi yang diinginkan dengan parameter tertentu sesuai dengan protokolnya ?",
      answers: [
      "A.	Routing protocol",
      "B.	Routing dinamik",
      "C.	Routing static ",
      ...
      {
        id: 13,
        text: "14.Apakah contoh dari Dynamic Router Protokol ?",
        answers: [
        "A.	Router ",
        "B.	RIP",
        "C.	IGRP",
        ...
        {
          id: 14,
          text: "15.Router protocol yang sering dijumpai sebab include di dalam operating sistem adalah ?",
          answers: [
          "A.	RIP",
          "B.	EGP",
          "C.	DGP",
